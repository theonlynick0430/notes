...
Despite the theoretical appeal of the VAE framework, it suffers from a critical drawback: it often produces blurry outputs\footnote{The limitation we study here is specific to the common VAE setup introduced

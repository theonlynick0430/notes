...
This section traces the origins of diffusion models by reviewing three foundational perspectives that have shaped the field. \Cref{fig:part-b-roadmap} provides an overview of this part.
...
\begin{figure}[th!]
  ...
  \caption{\textbfs{Timeline of diffusion model perspectives.} Each group shares the same color. 
  \\
